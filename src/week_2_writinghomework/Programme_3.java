 ...
 * 3.6 Call both instance and static methods into the Mail method and run the programme.
 */
public class Programme_3 {
    ...
    //3.5 Declare the Main method
    //3.6 Declare both instance and static methods into the main method and run the programme.
